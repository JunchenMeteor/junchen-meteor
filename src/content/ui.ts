...
export const uiCopy = {
  en: {
    ...
    projects: {
      ...
      pageIntro:
        "MeteorTest is the center of the current system, with companion repositories that cover test implementation, agent guardrails, creator tooling, voice practice, workflow packaging, and the public homepage itself.",
  ...
  zh: {
    ...
    projects: {
      ...
      pageIntro: "MeteorTest 是当前项目体系的中心，配套仓库覆盖测试实现、Agent 工作规则、创作工具、语音练习、工作流打包和个人主页本身。",
      ecosystemRole: "生态角色",
